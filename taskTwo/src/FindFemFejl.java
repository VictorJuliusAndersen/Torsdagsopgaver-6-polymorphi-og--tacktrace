//Task 2
    public class FindFemFejl {
        public static void main(String[] args) {
            ...
            biogrande.reserve(numberOfRows-1, numberOfSeats-1);   //fejl Her skal man trække 1 fra både numberOfRows og numberOfSeats, da indeksering i Java starter fra 0
